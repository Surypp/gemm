...
// --- launch wrapper ---
template <typename Tag>
void launch_gemm_naive(GemmDescRowMajor<Tag>& desc, cudaStream_t stream = 0) {
...
extern template void launch_gemm_naive<FP32Tag>(GemmDescRowMajor<FP32Tag>&, cudaStream_t);
extern template void launch_gemm_naive<FP16Tag>(GemmDescRowMajor<FP16Tag>&, cudaStream_t);
